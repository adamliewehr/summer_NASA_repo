...
'''
LATLONDATA = "./testData/ABI_EAST_GEO_TOPO_LOMSK.nc"
CLOUDSATPATH = './testData/cloudsat/'
ROOT_DIR = './testData/cloudsat/2B-CLDCLASS-LIDAR'
ABIDATA = "./testData/GOES_Data" #"/css/geostationary/BackStage/GOES-16-ABI-L1B-FULLD/"
#SAVEDIR = './testData/cropTestOutput'
SAVEDIR = '/home/al8425b-hpc/NASA/cropTest/testData/cropTestOuput/'
